...
INSERT INTO Departamento(DepNum, Nome, Local)
Values (2, 'Informática', 'Covilhã');

INSERT INTO Departamento(DepNum, Nome, Local)
Values (3, 'Produção', 'Guarda');
...
VALUES (1, 'José', 'Artista', 230000,1);
...
INSERT INTO EMPREGADO
VALUES (4, 'Zezinho', 'Artes gráficas', 150000,1);                                         

INSERT INTO EMPREGADO
VALUES (5, 'Abílio', 'Chefe secção', 100000,3);

INSERT INTO EMPREGADO
VALUES (6, 'António', 'Design', 100000,3);
...
INSERT INTO EMPREGADO
VALUES (9, 'Fazenda', 'Patrão', 6000000,4);

INSERT INTO EMPREGADO
VALUES (10, 'Marília', 'Secretária', 85000,4);
...
Values (1, 'Rir à gargalhada', 60000);
